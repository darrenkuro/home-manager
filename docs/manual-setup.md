...
| Alfred prefs folder → `~/Documents` (iCloud-synced) | mac          | checked                    | Alfred → Advanced → Syncing; syncs workflows/settings across Macs                              |
| Claude Code login                                   | mac          | checked                    | `claude` → `/login`                                                                            |
| Claude Code plugins                                 | mac          | checked (rebuild warns)    | `claude plugin install <name>@claude-plugins-official`                                         |
