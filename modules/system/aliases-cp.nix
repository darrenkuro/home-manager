...
in
{
    programs.zsh.shellAliases = {
        ...
        inix = badge
        "![Nix](https://img.shields.io/badge/-Nix-3f3f3f?style=flat-square&logo=nixos&logoColor=white)";
        itw = badge
        ...
        izod = badge
        "![Zod](https://img.shields.io/badge/-Zod-3C2A4D?style=flat-square&logo=zod&logoColor=white)";
        imake = badge
