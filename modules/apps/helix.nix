{ ... }: let
    ...
    fmt = ext: { command = "dprint"; args = [ "fmt" "--stdin" "file.${ext}" ]; };
in
{
    programs.helix = {
        enable = true;
        ...
        settings = {
            ...
            editor = {
                ...
                whitespace = { render.tab = "all"; characters.tab = "→"; };
            };
        };
    };
    ...
    programs.zsh.shellAliases = { h = "hx"; hmhx = "hx $HM/modules/apps/helix.nix"; };
}
